...
class UserProfile(models.Model):
    ...
    profile_pic=models.ImageField(upload_to="profilepics",null=True, default='/profilepics/user.png')
    bio=models.CharField(max_length=200,null=True)
    address=models.CharField(max_length=200,null=True)
    dob=models.DateTimeField(null=True)
    following=models.ManyToManyField("self",related_name="followed_by",symmetrical=False)
    created_date=models.DateTimeField(auto_now_add=True)
    cover_pic=models.ImageField(upload_to='images/cover_pic',blank=True, default='/profilepics/default.jpeg')
